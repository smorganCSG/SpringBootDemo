...
node('maven') {
	...
	stage('Flyway Migration') {
		...
		flywayrunner credentialsId: 'ConferenceDB', flywayCommand: 'repair', installationName: 'flyway', locations: sqlFilesDir, url: 'jdbc:postgresql://postgresql.srm-conference-services.svc/conferencedb'
